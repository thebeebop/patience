          ...
          <div className={bool ? "visible-element" : "hidden-element"}>
            <section className="brief-history-section" ref={targetRef}>
              ...
              >
                ...
                end of 2021, I decided that I wanted to pursue a different
                career path and started to learn Software Development.
              </p>
              ...
              >
                After graduating from the Northcoders' bootcamp, I've continued
                to learn and to challenge my knowledge by undertaking my own
            ...
            <section className="vanity-section">
              <h1 style={{ fontSize: 45, marginBottom: 30 }}>
                Personal Stuff:
              </h1>
            ...
            <section className="books-read-section">
              <h1 style={{ fontSize: 40, marginBottom: 60 }}>
                Favourite books:
              </h1>
