      ...
      <article id="hang-man">
        <div className="mother-container">
          ...
          <div className={bool ? "visible-element" : "hidden-element"}>
            ...
            <section className="development-section" id="hangman-development">
            ...
            {/* <section className="game-logic-section">
              ...
              <ul className="list-numbers">
                ...
                <li>
                  If the player manages to guess all 18 words without being
                  hung, they win.
                </li>
                <li>
                ...
                <li>
                  The player must reveal the word by guessing the correct
                ...
                <li>
                  With each life lost, the hangman is drawn in incremental
                  steps.
                </li>
                <li>
            ...
            <section className="hangman-illustration-section">
            ...
            <section className="challenges" id="hangman-challenges">
              ...
              <p style={{ marginBottom: 50 }}>
                ...
                with the characters in the hidden word and then discerning
                between the right and wrong characters, whilst at the same time
                revealing correctly gussed characters to the player in real time
              ...
              <div className="solution-one">
                <ul className="solution-list">
                  <li>
                    <p>
                      The inputted characters from the user were filtered
                      through a function that would take the input as one
                      argument.
                    </p>
                  </li>
                  <li>
                    <p>
                      ...
                      characters within the hidden word using the .includes
                      array method, which was stored as a global array variable.
                    </p>
                  </li>
                  <li>
                    <p>
              ...
              <div className="solution-two">
                <ul className="solution-list">
                  ...
                  <li>
                    <p>
                      If a correctly gussed character was present, this would
                      then replace all obscured charaters '-' in the hidden word
                      array with the correctly guessed characters.
                    </p>
                  </li>
                </ul>
              </div>
